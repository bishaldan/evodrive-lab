...
The remainder of the paper is organized as follows. Section 2 describes the benchmark setup and evaluation interface. Section 3 summarizes the compared training methods. Section 4 presents the experimental protocol. Section 5 reports the main comparison and ablations, and the final sections discuss limitations and conclusions.
