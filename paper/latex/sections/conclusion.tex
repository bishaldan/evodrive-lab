...
With a fixed experiment protocol, aggregate reporting pipeline, and open-source implementation, EvoDrive Lab can serve as a useful entry point for future work on lightweight driving benchmarks, neuroevolution, and procedural generalization. The final empirical takeaway of this paper should be framed around comparative behavior inside this benchmark rather than broad claims about autonomous driving more generally.
